...
class TestPreflightValidation(unittest.TestCase):
    ...
    def test_정상은_오류없음(self):
        errs, warns = validator.validate(self.full())
        self.assertEqual(errs, [])

    def test_깨진_사고유형_enum(self):
    ...
    def test_이용자수_미상은_경고이지_오류아님(self):
